...
namespace Script::Language::AST::ParsingTools
{
	struct Context
	{
		explicit Context(Core::InstructionContainer& c_container, Scope::NormalScope& c_scope, CppUtils::Language::Reader::Cursor c_cursor, bool c_verbose):
	...
	public:
		...
		CppUtils::Language::Reader::Cursor cursor;
		bool verbose;
	};
	...
	template<class ParsingFunction>
	struct NamedParser
	{
		std::string name;
