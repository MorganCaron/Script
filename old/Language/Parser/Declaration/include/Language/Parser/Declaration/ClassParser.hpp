...
{
	[[nodiscard]] std::unique_ptr<AST::Core::Instruction> parseClass(AST::ParsingTools::Context& context)
	{
		...
		auto className = std::string{cursor.getKeywordRequired("Le mot clef "s + AST::Object::Class::Keyword.data() + " doit etre suivi d un nom.")};
		if (verbose)
		{
