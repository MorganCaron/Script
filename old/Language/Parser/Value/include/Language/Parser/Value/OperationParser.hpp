...
{
	[[nodiscard]] std::unique_ptr<AST::Core::Instruction> parseOperation(AST::ParsingTools::Context& context, std::unique_ptr<AST::Core::Instruction>&& lhs = nullptr, std::unique_ptr<AST::Operator::Operator>&& nextOperator = nullptr)
	{
